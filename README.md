...
This isn't in package control, but there's one with similar fuctionality in there called [Magicless Quotes](https://github.com/daryltucker/MagiclessQuotes). Mine is better :grinning:.     
