...
This isn't in package control, but there's one with similar fuctionality in there called [Magicless Quotes](https://github.com/daryltucker/MagiclessQuotes). Mine is better though.  :-)   (But actually.  Mine uses fast string replacement rather than [slow regex](http://stackoverflow.com/questions/5668947/use-pythons-string-replace-vs-re-sub), and replaces on command rather than automatically on save.)
